...
const AnalyticsChart: FC<Props> = (props) => {
	const {isDataSuccess, isDataPending, isDataNotEmpty, isChartListNotEmpty, isMainCriterionSelected, chartData, chartType} = props;
	...
	return (
		<>
			...
			{
				isDataPending && <Skeleton className={'w-full h-[500px] rounded-md border'}/>
			}
